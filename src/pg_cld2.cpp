...
pg_cld2_detect_language_internal(PG_FUNCTION_ARGS)
{
    ...
    values[8]  = CStringGetTextDatum( mll_ulscriptname );       // MLL script name
    values[9]  = CStringGetTextDatum( mll_ulscriptcode );       // MLL script code
    values[10] = PointerGetDatum(NULL);                         // MLL ts_name

    values[11] = CStringGetTextDatum( cld2_language_name3[0] ); // language_1_cld2_name
    values[12] = CStringGetTextDatum( language_cname3[0] );     // language_1_language_cname
    values[13] = CStringGetTextDatum( language_code3[0] );      // language_1_language_code
    values[14] = CStringGetTextDatum( ulscriptname3[0] );       // language_1_script_name
    values[15] = CStringGetTextDatum( ulscriptcode3[0] );       // language_1_script_code
    values[16] = percent3[0];                                   // language_1_percent
    values[17] = normalized_score3[0];                          // language_1_normalized_score
    values[18] = PointerGetDatum(NULL);                         // language_1_ts_name

    values[19] = CStringGetTextDatum( cld2_language_name3[1] ); // language_2_cld2_name
    values[20] = CStringGetTextDatum( language_cname3[1] );     // language_2_language_cname
    values[21] = CStringGetTextDatum( language_code3[1] );      // language_2_language_code
    values[22] = CStringGetTextDatum( ulscriptname3[1] );       // language_2_script_name
    values[23] = CStringGetTextDatum( ulscriptcode3[1] );       // language_2_script_code
    values[24] = percent3[1];                                   // language_2_percent
    values[25] = normalized_score3[1];                          // language_2_normalized_score
    values[26] = PointerGetDatum(NULL);                         // language_2_ts_name

    values[27] = CStringGetTextDatum( cld2_language_name3[2] ); // language_3_cld2_name
    values[28] = CStringGetTextDatum( language_cname3[2] );     // language_3_language_cname
    values[29] = CStringGetTextDatum( language_code3[2] );      // language_3_language_code
    values[30] = CStringGetTextDatum( ulscriptname3[2] );       // language_3_script_name
    values[31] = CStringGetTextDatum( ulscriptcode3[2] );       // language_3_script_code
    values[32] = percent3[2];                                   // language_3_percent
    values[33] = normalized_score3[2];                          // language_3_normalized_score
    values[34] = PointerGetDatum(NULL);                         // language_3_ts_name
